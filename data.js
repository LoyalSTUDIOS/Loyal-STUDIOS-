...
const ITEMS = [
  ...
  { id:77, genero:"hombre", marca:"Tommy Hilfiger", marca_id:"tommy", badge:"new", stock:true,
    ...
    desc:"Verde musgo lavado. Logo bordado tono sobre tono, fleece grueso, capucha forrada. Nuevo con etiqueta. Esa onda 90s que no se va nunca.",
  ...
  { id:76, genero:"hombre", marca:"New Balance", marca_id:"newbalance", badge:"new", stock:true,
    ...
    desc:"Negro total. Malla técnica, logo NB reflectante, cordón ajustable. Nuevos con etiqueta. Calidad que no necesita gritar.",
  ...
  { id:75, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"Azul marino. Tela woven liviana, Swoosh bordado al tono, cordón ajustable. Nuevo con etiqueta. Cómodo sin bajar el nivel.",
  ...
  { id:74, genero:"hombre", marca:"Adidas", marca_id:"adidas", badge:"new", stock:true,
    ...
    desc:"Negro total. Doble cargo funcional, tela ripstop, corte relajado. Nuevo con etiqueta. Para la calle, no para el uniforme.",
  ...
  { id:73, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"Blanco con el Swoosh en gráfica de atardecer, a todo color. Algodón de peso real. Nueva. La que nadie más tiene puesta.",
  ...
  { id:72, genero:"hombre", marca:"De Primera", marca_id:"deprimera", badge:"new", stock:true,
    ...
    desc:"Blanco total. Brújula bordada tono sobre tono al pecho, fleece pesado, silueta relajada. Nuevo con etiqueta. No hace falta gritarlo.",
  ...
  { id:71, genero:"hombre", marca:"Air Jordan", marca_id:"jordan", badge:"new", stock:true,
    ...
    desc:"Crema con el parche Flight al pecho. Fleece premium, capucha forrada, fit relajado. Nuevo con etiqueta. Combina con todo, sube el nivel.",
  ...
  { id:70, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    precio:"Bs. 390", tallas:["L"],
    desc:"Canela, un color que no se ve todos los días. Cargo funcional, Swoosh bordado, tela de peso real. Nuevo con etiqueta.",
  ...
  { id:69, genero:"hombre", marca:"Air Jordan", marca_id:"jordan", badge:"new", stock:true,
    ...
    desc:"Gris jaspeado. Hoodie full-zip + jogger a juego, Jumpman bordado en ambas piezas. Fleece de peso real, nuevo con etiqueta. Salís del clóset, ya estás listo.",
  ...
  { id:68, genero:"hombre", marca:"The North Face", marca_id:"northface", badge:"new", stock:true,
    ...
    desc:"El puffer que se reconoce a dos cuadras. Azul marino y negro, relleno 700, capucha ajustable. Nuevo con etiqueta. Para el frío real de Bolivia.",
  ...
  { id:67, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"Azul marino con el box logo amarillo a todo color. Casaca coach a presión + jogger a juego. Nuevo con etiqueta. Se nota antes de que hables.",
  ...
  { id:66, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"El básico que nunca falla. Hoodie full-zip + jogger en negro, Swoosh bordado en ambas piezas. Nuevo con etiqueta. Todos los días, todo el año.",
  ...
  { id:65, genero:"hombre", marca:"Air Jordan", marca_id:"jordan", badge:"new", stock:true,
    ...
    desc:"Negro total. Parche Flight bordado al pecho, cuello y puños en rib, relleno ligero. Nuevo con etiqueta. Ponételo y volá.",
