...
const ITEMS = [
  ...
  { id:77, genero:"hombre", marca:"Tommy Hilfiger", marca_id:"tommy", badge:"new", stock:true,
    ...
    desc:"Tommy Jeans en clave washed: verde musgo lavado con el logo bordado tono sobre tono en el pecho, capucha forrada, fleece grueso premium. Nuevo con etiqueta. Esa energía relajada de los 90s que nunca pasa de moda.",
  ...
  { id:76, genero:"hombre", marca:"New Balance", marca_id:"newbalance", badge:"new", stock:true,
    ...
    desc:"Shorts New Balance de malla técnica en negro total, logo NB reflectante en la pierna, cintura elástica con cordón. Nuevos con etiqueta. Calidad callada, la que NB nunca necesita gritar.",
  ...
  { id:75, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"El pantalón woven de Nike en azul marino: tela liviana y estructurada, cintura elástica con cordón, Swoosh bordado al tono. Nuevo con etiqueta. Cómodo sin que parezca que te importó poco.",
    fotos:["fotos_catalogo/Hombre/75/IMG_1405.jpg","fotos_catalogo/Hombre/75/IMG_1413.jpg","fotos_catalogo/Hombre/75/IMG_1415.jpg","fotos_catalogo/Hombre/75/IMG_1418.jpg","fotos_catalogo/Hombre/75/IMG_1423.jpg"]},
  ...
  { id:74, genero:"hombre", marca:"Adidas", marca_id:"adidas", badge:"new", stock:true,
    ...
    desc:"Adidas Double Cargo en negro total: doble bolsillo cargo funcional, tela ripstop resistente, corte relajado con cordón ajustable. Nuevo con etiqueta. El cargo pensado para la calle, no para el uniforme.",
  ...
  { id:73, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"Remera Nike blanca con gráfica a todo color del Swoosh estilo atardecer del desierto — pieza de colección, no la típica básica. Algodón de peso real. Para los que buscan algo que nadie más tiene puesto.",
  ...
  { id:72, genero:"hombre", marca:"De Primera", marca_id:"deprimera", badge:"new", stock:true,
    ...
    desc:"Stone Island en blanco total: el parche de la brújula bordado tono sobre tono al pecho, fleece pesado premium, silueta relajada. Nuevo con etiqueta. Lujo tranquilo — el que reconocen los que saben, sin necesitar gritarlo.",
  ...
  { id:71, genero:"hombre", marca:"Air Jordan", marca_id:"jordan", badge:"new", stock:true,
    ...
    desc:"Hoodie Jordan en crema con el parche circular Flight en naranja al pecho. Fleece premium, capucha forrada, fit relajado. Nuevo con etiqueta. La energía de la cancha, en un tono que combina con todo.",
  ...
  { id:70, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    precio:"Bs. 390", tallas:["L"],
    desc:"Cargo Nike en canela: bolsillo cargo funcional con Swoosh bordado, cintura y botamanga con cordón ajustable, tela resistente de peso real. Nuevo con etiqueta. Un color que no se ve todos los días en Bolivia.",
    fotos:["fotos_catalogo/Hombre/70/IMG_2346.jpg","fotos_catalogo/Hombre/70/IMG_2347.jpg","fotos_catalogo/Hombre/70/IMG_2354.jpg","fotos_catalogo/Hombre/70/IMG_2356.jpg","fotos_catalogo/Hombre/70/IMG_2358.jpg","fotos_catalogo/Hombre/70/IMG_2361.jpg"]},
  ...
  { id:69, genero:"hombre", marca:"Air Jordan", marca_id:"jordan", badge:"new", stock:true,
    ...
    desc:"Conjunto Jordan completo en gris jaspeado: hoodie full-zip y jogger a juego, Jumpman bordado en ambas piezas. Fleece de peso real, nuevo con etiqueta. Combo listo para salir sin pensar dos veces.",
  ...
  { id:68, genero:"hombre", marca:"The North Face", marca_id:"northface", badge:"new", stock:true,
    ...
    desc:"El puffer que todo Cochabamba reconoce de lejos: bloque azul marino y negro, relleno de plumas 700, capucha ajustable con cordón. Nuevo con etiqueta. Para el frío de verdad de las noches del Altiplano.",
  ...
  { id:67, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"Conjunto Nike en azul marino con el box logo amarillo a todo color: casaca coach a presión y jogger a juego. Nuevo con etiqueta, las dos piezas. Ese golpe de color que separa el fit del resto.",
  ...
  { id:66, genero:"hombre", marca:"Nike", marca_id:"nike", badge:"new", stock:true,
    ...
    desc:"El básico que nunca falla, completo: hoodie full-zip y jogger Club Fleece en negro, Swoosh bordado en ambas piezas. Nuevo con etiqueta. El conjunto de todos los días, hecho bien.",
    fotos:["fotos_catalogo/Hombre/66/FullSizeRender.jpg","fotos_catalogo/Hombre/66/IMG_0010.jpg","fotos_catalogo/Hombre/66/IMG_0011.jpg","fotos_catalogo/Hombre/66/IMG_0012.jpg","fotos_catalogo/Hombre/66/IMG_0013.jpg","fotos_catalogo/Hombre/66/IMG_0014.jpg","fotos_catalogo/Hombre/66/IMG_0015.jpg","fotos_catalogo/Hombre/66/IMG_0016.jpg"]},
  ...
  { id:65, genero:"hombre", marca:"Air Jordan", marca_id:"jordan", badge:"new", stock:true,
    ...
    desc:"Bomber Jordan en negro con el parche Flight bordado al pecho, cuello y puños en rib, relleno ligero para el frío boliviano. Nuevo con etiqueta. La chaqueta que hace que cualquier fit se vea terminado.",
